...
public class MEasyLevelControlScript : MonoBehaviour {
	...
	void Start () {
		...
		score = PlayerPrefs.GetInt ("MEasyScore");
	...
	{
		PlayerPrefs.SetInt ("MEasyScore", score);
	...
	void LoadNextLevel()
	{
		...
		if (num_question != 20) {
			...
			SceneManager.LoadScene ("MEasy31");
		}
	}
