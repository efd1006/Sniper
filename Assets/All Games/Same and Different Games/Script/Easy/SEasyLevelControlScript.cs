...
public class SEasyLevelControlScript : MonoBehaviour {
	...
	void Start () {
		...
		score = PlayerPrefs.GetInt ("SEasyScore");
	...
	public void ScoreManager()
	{
		...
		PlayerPrefs.SetInt ("SEasyScore", score);
	...
	void LoadNextLevel()
	{
		...
		if (num_question != 20) {
			...
			SceneManager.LoadScene ("SEasy31");
		}
	}
	...
	int randomize() {
		int index = Random.Range (211, 240);
		return index;
	}
