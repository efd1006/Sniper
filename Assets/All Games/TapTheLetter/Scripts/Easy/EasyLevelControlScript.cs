...
public class EasyLevelControlScript : MonoBehaviour {

	private int score;
	public float time;
	private int num_question = 0;
	private ArrayList used_index = new ArrayList();
	...
	void Start () {
		...
		score = PlayerPrefs.GetInt ("EasyScore");
